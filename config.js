...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'Asᴍᴏᴅᴇᴜs-Eᴘᴢɪ;🇶🇺🇪🇪🇳-🇩;https://i.ibb.co/Pr4BfhZ/1500x1500.png',
  ...
  ALIVE_DATA : process.env.ALIVE_DATA || "_*Hy &sender Queen D is alive now*_\n\n_PLATFORM: &platform_\n_RUNTIME : &runtime_\n\n_Epzi Might be Not available here for now u can use me if u like_\n\n_For Commands: ```.menu```",
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_0e9c_892c_c31c_a461_8315_5dde_400c_7451',
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "ϙᴜᴇᴇɴ-ᴅ", "body": "Asᴍᴏᴅᴇᴜs Eᴘᴢɪ 👽", "thumbnailUrl": "https://i.ibb.co/Pr4BfhZ/1500x1500.png", "renderLargerThumbnail": false, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://www.instagram.com/yuren.sasanka/", "showAdAttribution": false}`,
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '🇶🇺🇪🇪🇳-🇩;ᴡᴀʙᴏᴛ',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;ϙᴜᴇᴇɴ-ᴅ;https://i.ibb.co/Pr4BfhZ/1500x1500.png',
  ...
  BOT_INFO: process.env.BOT_INFO || 'ϙᴜᴇᴇɴ-ᴅ;Asᴍᴏᴅᴇᴜs-Eᴘᴢɪ;https://graph.org/file/1506e5842805b0968c5cf.mp4',
