...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'Asᴍᴏᴅᴇᴜs Eᴘᴢɪ 💸;ϙᴜᴇᴇɴ-ᴅ;https://i.ibb.co/7yNfxp6/IMG-20240601-WA0013.jpg',
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_y0u1_y627_635y_24w9_63v9_84uw_5828_7u26',
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "ϙᴜᴇᴇɴ-ᴅ-ᴍᴅ", "body": "Asᴍᴏᴅᴇᴜs Eᴘᴢɪ 💸", "thumbnailUrl": "https://i.ibb.co/7yNfxp6/IMG-20240601-WA0013.jpg", "renderLargerThumbnail": false, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://github.com/HaCkr-EPZI-public/Queen-D", "showAdAttribution": true}`,
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'ϙᴜᴇᴇɴ-ᴅ;ᴡᴀʙᴏᴛ',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;ϙᴜᴇᴇɴ-ᴅ-ᴍᴅ;https://i.ibb.co/7yNfxp6/IMG-20240601-WA0013.jpg',
  MENU_FONT: process.env.MENU_FONT || "0;0",
  SUDO: process.env.SUDO || '+94759554531',
  ...
  GEMINI: process.env.GEMINI || "AIzaSyCfrNcPDJPhi0cbXZ-wyJG702572jtGBuU",
  LOG_MSG: toBool(process.env.LOG_MSG) || true,
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || '',
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || '',
  BOT_INFO: process.env.BOT_INFO || 'ϙᴜᴇᴇɴ-ᴅ;Asᴍᴏᴅᴇᴜs Eᴘᴢɪ 💸;https://github.com/HaCkr-EPZI-public/CuduNona/raw/refs/heads/main/media/VID-20241110-WA0141(1).mp4',
